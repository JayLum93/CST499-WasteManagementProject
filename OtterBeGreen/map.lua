...
function newMap()
	...
	--[[local background = display.newImage( "", true )
	background.x = display.contentWidth / 2
	background.y = display.contentHeight / 2 --]]
	-- Create a native map view

	--local shadow = display.newRect( -150, -220, 306, 226 )
	--shadow.anchorX = 0.0		-- TopLeft anchor
	--shadow.anchorY = 0.0		-- TopLeft anchor
	--shadow:setFillColor( 255, 0, 0, 120/255 )

	--shadow.x = display.contentCenterX - 152
	--shadow.y = display.contentCenterY - 150

	--local simulatorMessage = "MapView is not supported on \n\nthis platform.You should build for\n\n iOS or Android to try MapView.\n\n"
	--local label = display.newText( simulatorMessage, -150,-150, -75, -75, native.systemFont, 14 )
...
-- myMap.anchorY = 0.0		-- TopLeft anchor
	...
	myMap:setCenter(36.65448, -121.80004)
