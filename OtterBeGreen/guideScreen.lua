...
local hazTextObj2 = display.newText(hazText2, 0, -110, 280, 0, native.systemFont, 17)
...
local foodTextObj2 = display.newText(foodText2, 0, -110, 280, 0, native.systemFont, 17)
...
local foodTextObj3 = display.newText(foodText3, 0, -110, 280, 0, native.systemFont, 17)
...
local garTextObj2 = display.newText(garText2, 0, -110, 280, 0, native.systemFont, 17)
...
local garTextObj3 = display.newText(garText3, 0, -110, 280, 0, native.systemFont, 17)
garTextObj3:setTextColor (0)
garTextObj3.x = display.contentCenterX
--scrollView:insert(garText3)
...
garTextObj4 = display.newText(garText4, 0, -110, 280, 0, native.systemFont, 17)
...
local garTextObj5 = display.newText(garText5, 0, -110, 280, 0, native.systemFont, 17)
...
local garTextObj6 = display.newText(garText6, 0, -110, 280, 0, native.systemFont, 17)
garTextObj6:setTextColor (0)
